...
public class AddLunchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.addlunch), (v, insets) -> {
        ...
        ImageView btnAddLunch = findViewById(R.id.addButton);
        btnAddLunch.setOnClickListener(v -> {
            Intent intent = new Intent(AddLunchActivity.this, AddFoodActivity.class);
    ...
    private void logMeal(List<FoodItem> foodList) {
        ...
        DatabaseHelper db = new DatabaseHelper(this);
        db.insertMealLog(1, "Lunch", foodItems.toString(),foodMass.toString(), totalCalories, currentDateTime, currentDateTime);
