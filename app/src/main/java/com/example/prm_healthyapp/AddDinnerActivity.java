...
public class AddDinnerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.adddinner), (v, insets) -> {
        ...
        ImageView btnAddDinner = findViewById(R.id.addButton);
        btnAddDinner.setOnClickListener(v -> {
            Intent intent = new Intent(AddDinnerActivity.this, AddFoodActivity.class);
    ...
    private void logMeal(List<FoodItem> foodList) {
        ...
        DatabaseHelper db = new DatabaseHelper(this);
        db.insertMealLog(1, "Dinner", foodItems.toString(),foodMass.toString(), totalCalories, currentDateTime, currentDateTime);
