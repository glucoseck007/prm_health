...
public class AddBreakfastActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.addbreakfast), (v, insets) -> {
        ...
        ImageView btnAddBreakfast = findViewById(R.id.addButton);
        btnAddBreakfast.setOnClickListener(v -> {
            Intent intent = new Intent(AddBreakfastActivity.this, AddFoodActivity.class);
    ...
    private void logMeal(List<FoodItem> foodList) {
        ...
        DatabaseHelper db = new DatabaseHelper(this);
        db.insertMealLog(1, "Breakfast", foodItems.toString(),foodMass.toString(), totalCalories, currentDateTime, currentDateTime);
